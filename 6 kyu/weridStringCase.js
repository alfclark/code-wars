...
a string, and returns the same string with all even indexed characters 
...
index is even, therefore that character should be upper cased and you 
...
function toWeirdCase(string){
    let splitted = string.split(" ").map(s => s.split("").map((e,i) => i%2 ? e.toLowerCase() : e.toUpperCase()).join("")).join(" ")
